...
const specialityData = {
    1: { title: "Margherita Pizza", desc: "Classic pizza with fresh mozzarella, basil, and tomato sauce.", images: ["banner/bg2.png", "banner/bg2.png", "banner/bg2.png"], price: "$12.99", link: "manu/pizza.html" },

    2: { title: "Garlic Bread", desc: "Crispy bread toasted with butter, garlic, and herbs.", images: ["banner/bg2.png", "banner/bg2.png", "banner/bg2.png"], price: "$6.99", link: "manu/burger&french,fries.html" },

    3: { title: "Pepperoni Pizza", desc: "Loaded with pepperoni and mozzarella cheese.", images: ["banner/bg2.png", "banner/bg2.png", "banner/bg2.png"], price: "$13.99", link: "manu/pizza.html" },

    4: { title: "Veggie Supreme", desc: "Peppers, mushrooms, olives, and onions on crispy crust.", images: ["banner/bg2.png", "banner/bg2.png", "banner/bg2.png"], price: "$11.99", link: "manu/chinese-chillis.html" },

    5: { title: "Coke", desc: "Cold, refreshing cola drink. Perfect with your pizza.", images: ["banner/bg2.png", "banner/bg2.png", "banner/bg2.png"], price: "$2.99", link: "manu/coffee&tea.html" },

    6: { title: "Cheesy Crust", desc: "Pizza with extra cheese in the crust. Mozzarella overload!", images: ["banner/bg2.png", "banner/bg2.png", "banner/bg2.png"], price: "$14.99", link: "manu/pizza.html" },

    7: { title: "BBQ Chicken Pizza", desc: "Smoky BBQ sauce with grilled chicken and onions.", images: ["banner/bg2.png", "banner/bg2.png", "banner/bg2.png"], price: "$13.49", link: "manu/pizza.html" },

    8: { title: "Feta & Spinach", desc: "Fresh spinach with feta cheese and olive oil drizzle.", images: ["banner/bg2.png", "banner/bg2.png", "banner/bg2.png"], price: "$12.49", link: "manu/crispy&pasta.html" },

    9: { title: "Four Cheese", desc: "Blend of mozzarella, parmesan, cheddar, and ricotta.", images: ["banner/bg2.png", "banner/bg2.png", "banner/bg2.png"], price: "$13.49", link: "manu/pizza.html" },

    10: { title: "Spicy Jalapeño", desc: "Hot and fiery with jalapeños, red peppers, and spices.", images: ["banner/bg2.png", "banner/bg2.png", "banner/bg2.png"], price: "$12.99", link: "manu/pizza.html" }
};
...
function renderSpecialityCards() {
    ...
    Object.keys(specialityData).forEach(key => {
        ...
        const thumbHTML = item.images ? ("<img src=\"" + item.images[0] + "\" alt=\"" + item.title + "\">") : ("<div style=\"display:flex;align-items:center;justify-content:center;width:100%;height:100%;background:#f5f5f5;color:#666;font-size:14px;font-weight:600;\">" + (item.text ? item.text[0] : '') + "</div>");
